...
| 이름 | 담당 역할 | 주요 개발 내용 |
|:---:|:---:|:---|
| **팀원 1** | Backend / AI | - Django REST API 설계 및 구현<br>- GPT 기반 금융 상품 추천 알고리즘 개발<br>- 챗봇 의도 분류 시스템 구현<br>- 주식/환율/금속 시세 API 연동 |
| **팀원 2** | Frontend / Design | - Vue.js 컴포넌트 설계 및 구현<br>- 반응형 UI/UX 디자인<br>- Pinia 상태 관리<br>- 차트 시각화 (Chart.js) |
...
1. **수학적 검증**: 단순 금리 비교가 아닌, 목표 달성 가능성을 수학적으로 계산
2. **이자소득세 반영**: 실제 수령액 기준 15.4% 세금 자동 계산
3. **복합 전략**: 예금+적금 조합으로 최적의 포트폴리오 제안
4. **실시간 감성 분석**: 토스 증권 커뮤니티 크롤링 + AI 분석
...
### 팀원 2 (Frontend / Design)

> **잘한 점**
> - Pinia를 활용한 체계적인 상태 관리
> - 사용자 친화적인 UI/UX 구현
> - Chart.js를 활용한 데이터 시각화
>
> **아쉬운 점**
> - 반응형 디자인에 더 많은 시간을 투자했으면 좋았을 것
> - 컴포넌트 재사용성을 높이는 설계가 부족했음
>
> **배운 점**
> - Vue.js 3 Composition API 심화 학습
> - 프론트엔드-백엔드 협업 방식
> - 금융 도메인 지식
